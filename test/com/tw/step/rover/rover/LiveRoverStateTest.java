...
class LiveRoverStateTest {
    ...
    void shouldTurnAndStayLive() {
        ...
        RoverState nextState = state.turnLeft(Navigator.create(), new Plateau(new Coordinate(0, 0), new Coordinate(5, 5)));
    ...
    @Test
    void shouldBecomeDeadWhenRoverFallsOutsideBoundary() {

        Rover rover = new Rover(new Coordinate(0, 5), Direction.N);
        ...
        assertEquals("0 5 N LOST", rover.toString());
    }
}
